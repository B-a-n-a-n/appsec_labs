...
report: https://gist.github.com/B-a-n-a-n/d172e44a3dc27d43d3d5dce724efbc5e 
...
В ходе выполнения лабораторной работы был проведен комплексный аудит безопасности Docker-инфраструктуры с использованием двух дополняющих друг друга подходов: анализа конфигурации (Docker Bench для соответствия CIS Benchmark) и сканирования содержимого образов (Trivy).

report: https://gist.github.com/B-a-n-a-n/cd6c39583fcd7934ae4d709e5ed20c85
